...
body <- dashboardBody(
  ...
  tabItems(
    ...
    tabItem(tabName = "info",
            ...
            hr(),
            h3("Investigación"),
            HTML('<p>Este modelo corresponde al resultado de trabajo de investigación conjunto entre el <b>Grupo de Ingeniería Telemática (GIT) de la Universidad del Cauca, CIRAD y CATIE.</b></p>'),

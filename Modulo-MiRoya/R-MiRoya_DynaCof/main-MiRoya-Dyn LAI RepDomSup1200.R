...
#@@@@@@@@@  Rep Dom 2011-2018 Sup 1200m @@@@@@@@@@@@@

load("C:/Users/bommel/cormas2019/R/Outputs/sim_rep_dom_2003-2018_alt_sup1200.rda")
S$Sim$Date <- S$Meteo$Date
S$Sim <-subset(S$Sim, Date>="2011-01-01")
S$Meteo <- subset(S$Meteo, Date>="2011-01-01")

setDynacof(S)  #set S2
initializeSimulations("init1ParcelaRepDom_sup1200", FALSE, 10)  #run independently x weeks

...
#@@@@@@@@@  HONDURAS 2013-2018 Sup 1200m @@@@@@@@@@@@@

load("D:/cormas2019/R/DynACof/sim_honduras_2003-2018_alt_sup1200.rda")
S$Sim$Date <- S$Meteo$Date
S$Sim <-subset(S$Sim, Date>="2013-01-01")
S$Meteo <- subset(S$Meteo, Date>="2013-01-01")

setDynacof(S)  #set S2
initializeSimulations("initUnaParcelaHonduras_sup700", FALSE, 10)  #run independently x weeks

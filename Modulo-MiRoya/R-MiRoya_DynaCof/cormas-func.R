...
openVisualWorks <- function(GUI = T) {
if(GUI) {
...
runOneStep <- function(){  # By default stepSemanalDynacof: is called to run 1 week of MiRoya
#  return(askCormas("RunOneStep"))
  return(askCormas("SayHello"))
}

runSimu <- function(duration){

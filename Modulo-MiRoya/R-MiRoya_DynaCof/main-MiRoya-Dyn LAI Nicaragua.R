...
source("func-MiRoya-DynaCof.R")
  #parameters
  cormasInit <- "init1P_Nicaragua"
  S0_sim <- "S0_Nicaragua_2010-2015.rda"  #Name of the basic simulation without rust
  randomSeed <- NA #NA or a integer between 10.000 and 9.999.999

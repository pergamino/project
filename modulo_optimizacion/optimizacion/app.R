...
body <- dashboardBody(
    tabItems(
      ...
      tabItem(tabName = "App1",
              h2("Analis Random Forest"),
              fluidRow(
                 box("Datos de monitoreo",color = "light-blue",background = "light-blue",width = 3,
                     ...
                     numericInput("ano_actual",
                                  ...
                                  value=2019),
                     br(),
                     actionButton("action","Iniciar el analisis")
                     ),

                           box(title="Variables mas importantes", 
                               color = "teal",background = "teal",
                               withSpinner(plotOutput("plot_RF", height = 250)),
                               width = 4),
                 
                 box(title="Elegir las variables",
                       selectInput(
                       inputId = "V1",
                       label = "Variable 1",

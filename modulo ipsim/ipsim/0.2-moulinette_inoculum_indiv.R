...
moulinette_inoc <- function(datos_epidemio){
  ...
  # indice de ligne pour faire les calculs sur chaque incidence
  datos_epidemio$id_inc <- paste(datos_epidemio$fecha,datos_epidemio$altitud,datos_epidemio$variedad,datos_epidemio$incidencia)
...
#######################################
    ...
    tab_inc_mediana <- datos_epidemio
  
    tab_inc_mediana$ipsim <- ifelse(tab_inc_mediana$incidencia<10,"Inoculum bajo",
                                    ifelse(tab_inc_mediana$incidencia>30,"Inoculum alto","Inoculum medio"))

    tab_inc_mediana$cat <- ifelse(tab_inc_mediana$incidencia<10,1,
                                  ifelse(tab_inc_mediana$incidencia>30,3,2))
  ...
  #######################################
    ...
    defoliacion <- 30*(0.0125*tab_inc_mediana$incidencia + 0.2186)
